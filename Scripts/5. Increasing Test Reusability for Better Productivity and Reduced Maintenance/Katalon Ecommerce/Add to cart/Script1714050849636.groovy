...
WebUI.callTestCase(findTestCase('5. Increasing Test Reusability for Better Productivity and Reduced Maintenance/Katalon Ecommerce/Login to shop'), 
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Katalon Ecommerce/Page_Happy Ninja  Katalon Shop/div_View cart Happy Ninja has been added to_368951'), 0)

WebUI.verifyElementPresent(findTestObject('Object Repository/Katalon Ecommerce/Page_Happy Ninja  Katalon Shop/nav_HomeClothingHoodiesHappy Ninja'), 0)
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Katalon Ecommerce/Page_Cart  Katalon Shop/a_Happy Ninja'), 0)
