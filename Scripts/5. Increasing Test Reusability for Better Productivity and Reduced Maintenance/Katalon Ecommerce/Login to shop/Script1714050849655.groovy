...
WebUI.verifyElementPresent(findTestObject('Object Repository/Katalon Ecommerce/Page_My account  Katalon Shop/strong_KatalonLover'), 0)

WebUI.verifyElementPresent(findTestObject('Object Repository/Katalon Ecommerce/Page_My account  Katalon Shop/nav_HomeMy account'), 0)
