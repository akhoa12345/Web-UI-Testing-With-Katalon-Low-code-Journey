...
String actualTitle = WebUI.getText(findTestObject('Object Repository/Page_CURA Healthcare Service/Page_CURA Healthcare Service/h2_Make Appointment'))

// initializing  variable that is defined at the start of code
